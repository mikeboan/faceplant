...
export const RECEIVE_SINGLE_AUTH_ERROR = "RECEIVE_SINGLE_AUTH_ERROR";
...
export const receiveSingleAuthError = error => ({
  error,
  type: RECEIVE_SINGLE_AUTH_ERROR
});
...
const auth = (state = _defaultState, action) => {
  switch (action.type) {
    ...
    case RECEIVE_SINGLE_AUTH_ERROR:
